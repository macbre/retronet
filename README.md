...
1. Paste the URL into the `url.mjs` file and run the `screenshot.mjs` script -> the `web_archive_<domain>_<hash>.png` file will be created with a screenshot of the web-archived page. The `screenshot.png` symkink will be also updated in the main directory.
